...
class parent{
	...
	private void methodB() {  // private is not inheritabvle, cannot be visible outside the class.
	...
	/* 
	  features that cannot be inherited:  1. constructor
										  2. features that are not visible:
										   			1. private AM.
										   			2. defult AM (when sub class and super class are not in same package).
